import { PlayersDrawing } from "./PlayersDrawing.js";
import { HarvestablesDrawing } from "./HarvestablesDrawing.js";
import { MobsDrawing } from "./MobsDrawing.js";
import { ChestsDrawing } from "./ChestsDrawing.js";
import { DungeonsDrawing } from "./DungeonsDrawing.js";
...
socket.addEventListener("message", (event) => {
  ...
  if (data.code === "request") {
    onRequest(data.dictionary.parameters);
  } else {
    onEvent(data.dictionary.parameters);
  }
});
...
function onRequest(Parameters) {
  const eventCode = Parameters[253];
